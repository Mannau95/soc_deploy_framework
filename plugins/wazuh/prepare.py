...
def main():
    ...
    # 3. Générer les certificats – on ignore le code de retour (erreur non fatale connue)
    ...
    # Vérifier la présence des fichiers minimum
    required = [
    ...
    # 4. Renommer les clés privées (.key -> -key.pem)
    renommage = {
